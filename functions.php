...
function load_my_scripts() {
  ...
  wp_enqueue_script( 'lottie-player','https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js', array());
  wp_enqueue_script( 'lottie-interactive','https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js', array());
  wp_enqueue_script( 'custo_script', get_template_directory_uri() . '/script1.js', array(), false, true );
